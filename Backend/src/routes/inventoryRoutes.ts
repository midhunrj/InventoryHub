...
import salesController from "../controllers/salesController";
 ...
 userRouter.put('/update-customer/:id',verifyToken,customerController.updateCustomer)
 userRouter.delete('/delete-customer/:id',verifyToken,customerController.deleteCustomer)
